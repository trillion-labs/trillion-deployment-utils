...
class TrillionConfig(PretrainedConfig):
    ...
    Args:
        ...
        attn_scale (`float`, *optional*, defaults to 0.1): scaling factor pertaining to attention temperature tuning
        floor_scale (`float`, *optional*, defaults to 0.1): scaling factor pertaining to attention temperature tuning
